...
?>
<div class="teacher-form-index">
    <p><?= Html::a('<i class="fa fa-plus"></i> New Teacher', ['create'], ['class' => 'btn btn-success']) ?></p>
            ...
            'template' => '{view} {update} {delete}',
                'buttons' => [
                    'view' => function ($url, $model, $key) {
                        return Html::a('', $url, ['title'=>'View Teacher', 
                            'class'=>'fa fa-user fa-2x']);
                    },
                    'update' => function ($url, $model, $key) {
                        return Html::a('', $url, ['title'=>'Manage Teacher', 
